...
export const styles = {
  ...
  // Controls (global)
  controls: {
    container: "bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-6",
    inner: "flex flex-col md:flex-row gap-4 justify-between",
    ...
    search: {
      container: "relative flex-1 min-w-[300px]",
      icon: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none",
      input:
        "w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent",
    },
  },
  ...
  table: {
    ...
    header:
      "px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer group",
    ...
    viewButton:
      "px-3 py-1.5 bg-indigo-100 text-indigo-700 rounded-lg text-xs hover:bg-indigo-200 transition-colors",
    footer:
  ...
  emptyState: {
    ...
    iconContainer:
      "inline-flex items-center justify-center w-16 h-16 bg-gray-100 rounded-full mb-4",
    icon: "text-gray-400 w-8 h-8",
  ...
  modal: {
    ...
    container:
      "bg-white rounded-xl shadow-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto",
    header: "border-b p-6 flex justify-between items-center",
    title: "text-xl font-bold text-gray-800",
    subtitle: "text-gray-600 text-sm mt-1",
    closeButton:
      "text-gray-500 hover:text-gray-700 p-1 rounded-full hover:bg-gray-100",

    grid: "p-6 grid grid-cols-1 md:grid-cols-2 gap-6",
    section: "border border-gray-200 rounded-xl p-5",
    ...
    footer: "border-t p-6 flex justify-end",
    footerButtonClose:
      "px-6 py-2 bg-gray-200 text-gray-800 rounded-lg mr-3 hover:bg-gray-300",
    footerButtonSave:
      "px-6 py-2 bg-[#43C6AC] text-white rounded-lg hover:bg-[#538a7f]",
  },

  // Order Summary
  summary: {
    item: "flex justify-between items-center border-b pb-3",
    title: "font-medium",
    category: "text-gray-600 text-sm",
    price: "text-right",
    totalItem: (isTotal) =>
      `flex justify-between ${isTotal ? "pt-2 border-t" : ""}`,
    totalLabel: "text-gray-600",
    totalValue: (isTotal) =>
      isTotal ? "font-bold text-lg text-[#43C6AC]" : "",
  },
  ...
  statusSelect:
    "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-[#41ad98] focus:border-transparent",
  ...
  booksList: {
    ...
    tableCell: "px-6 py-4",
    bookImage:
      "flex-shrink-0 h-12 w-12 bg-gray-200 border-2 border-dashed rounded-lg",
    bookTitle: "text-sm font-medium text-gray-900",
    categoryBadge:
      "px-2.5 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full",
    ...
    paginationButtonNext:
      "px-4 py-2 bg-gradient-to-r from-[#1A237E] to-[#43C6AC] text-white rounded-lg hover:opacity-90",
  },
  ...
  addBooks: {
    ...
    formInput:
      "w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent",
    formTextarea:
      "w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent",
  ...
  sidebar: {
    container: (isCollapsed) =>
      `bg-gradient-to-t from-[#2B5876] to-[#43C6AC] text-white min-h-screen p-4 transition-all duration-300 ease-in-out ${
  ...
  mobileNav: {
    container:
      "fixed bottom-0 left-0 right-0 bg-gradient-to-r from-[#2B5876] to-[#43C6AC] z-50 shadow-lg",
    nav: "flex justify-around items-center py-3",
    item: "flex flex-col items-center w-full",
    iconContainer: (isActive) =>
      `p-2 rounded-lg ${
        isActive ? "bg-white text-[#2B5876]" : "text-gray-300"
      }`,
    label: (isActive) =>
