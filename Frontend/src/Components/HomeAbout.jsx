import { homeAboutStyles as s } from "../assets/dummystyles.js";
import HomeAboutImage from "../assets/HomeAboutImage.png";
import { featuredBooks, hastats } from "../assets/dummydata.js";
        ...
        <div className={s.aboutGrid}>
          ...
          <div className="space-y-8">
            ...
            <p className={s.aboutText}>
              ...
              community where every reader feels at home.
            </p>
              ...
              <div className={s.bookCard}>
                ...
                <div className={s.bookContent}>
                  ...
                  <Link to="/books" className={s.discoverLink}>
                    <span>Discover</span>  <ArrowRight className={s.arrowSmall}/>
                  </Link>
                </div>
              </div>
            </div>
